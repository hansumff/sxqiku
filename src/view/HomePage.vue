    ...
    <div id="bigData" class="container-fuild">
      <div class="row bigData-container">
        <div class="col-xs-12 col-sm-12 col-md-6 wow zoomIn">
          <img class="img-responsive" src="@/assets/img/img1.png" alt="电动车物联网防盗管理系统方案">
        </div>
        <div class="col-xs-12 col-sm-12 col-md-6">
          ...
          <p>骑酷科技物联网智能安防系统，是骑酷科技基于多年技术累积的智慧城市物联网感知综合管理平台上构建，融合了RFID自动识别、物联网感知、GIS、云技术及移动互联网技术、实现对城市电动自行车辆的实时自动识别、定位跟踪，报警分发和移动式搜寻的综合应用处理能力，从而提升案件处理效率、预防盗窃事件发生，创造和谐的社会环境。整个电动车管理系统软件采用B/S架构，具有良好的扩展性和客户端按需定制的功能。</p>
          <p>整个电动车管理系统硬件由电子标签、基站、警务手持机、视频系统、云平台、PC web客户端及移动客户端构成。具有技术先进、性能稳定、使用便利、成本低等优点。</p>
